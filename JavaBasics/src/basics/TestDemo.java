...
public class TestDemo {
	...
	*/
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Object count is"+a);
		
		// If we the println statement in the main method then the output give as total count.
		...
		a++;
		System.out.println("My object count is" +a);
